...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Dopecoin");
    QApplication::setOrganizationDomain("dopecoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Dopecoin-Qt-testnet");
    else
        QApplication::setApplicationName("Dopecoin-Qt");
